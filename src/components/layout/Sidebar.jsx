import {
  LayoutDashboard, Users, CalendarDays, Sparkles, Pill, IndianRupee,
...
export default function Sidebar({ active, onNavigate, mobileOpen, onCloseMobile }) {
  ...
  // Filter the NAV array based on role
  ...
  return (
    <>
      ...
      <aside className={`fixed md:sticky top-0 h-screen w-60 bg-sidebar border-r border-sidebar-border z-50 flex flex-col transition-transform duration-200 ${mobileOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'}`}>
