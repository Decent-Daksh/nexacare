      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div className="bg-card border border-border rounded-xl p-5 shadow-sm border-l-4 border-l-[var(--ai)]">
          ...
          <ul className="space-y-3 text-sm">
            ...
            {/* RBAC check: Only Doctors/Admins see sensitive patient-specific health alerts */}
            ...
            {appts?.slice(0, 6).map((a) => (
              ...
              >
                <div className="w-12 text-center text-xs">
                  <div className="text-muted-foreground">{a.time.split(":")[0]}h</div>
                  <div className="font-mono">{a.time.split(":")[1]}</div>
                </div>
                
                {/* Security logic: Hide Avatar for managers */}
                {role !== "manager" && <Avatar name={a.patientName} size={34} />}
                
                <div className="flex-1 min-w-0">
                  {/* Security logic: Mask name for managers */}
